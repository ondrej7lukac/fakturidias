    ...
    <cac:AccountingSupplierParty>
        <cac:Party>
            ...
            <cac:PostalAddress>
                ...
                <cac:Country><cbc:IdentificationCode>${supplier.ico?.startsWith('CZ') ? 'CZ' : 'SK'}</cbc:IdentificationCode></cac:Country>
            </cac:PostalAddress>
            <cac:PartyTaxScheme>
    ...
    <cac:AccountingCustomerParty>
        <cac:Party>
            ...
            <cac:PostalAddress>
                ...
                <cac:Country><cbc:IdentificationCode>${client.ico?.startsWith('CZ') ? 'CZ' : 'SK'}</cbc:IdentificationCode></cac:Country>
            </cac:PostalAddress>
            <cac:PartyTaxScheme>
...
module.exports = { generatePeppolXml };
