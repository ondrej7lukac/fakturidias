...
export default function WelcomeScreen({
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        text.unlimited5Feature1,
        text.unlimited5Feature2,
        text.unlimited5Feature3,
      ],
      accent: true,
    },
    {
      ...
      features: [
        text.unlimitedFeature1,
        text.unlimitedFeature2,
        text.unlimitedFeature3,
        text.unlimitedFeature4,
      ],
      accent: false,
    },
  ];
    ...
    <div className='welcome-screen'>
      <div className='welcome-container'>
        ...
        <p className='welcome-footer'>
          {lang === 'cs'
            ? 'Začněte zdarma, žádná kreditní karta není nutná'
